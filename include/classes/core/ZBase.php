...
class ZBase {
	...
	protected function init() {
		...
		// system includes
                require_once $this->getRootDir().'/conf/system_settings.ini.php';
	...
	private function getIncludePaths() {
		return [
			...
			$this->rootDir.'/include/classes/pagefilter',
                        $this->rootDir.'/include/classes/sysset',
			$this->rootDir.'/local/app/controllers',
			$this->rootDir.'/app/controllers',
                        $this->rootDir.'/include/classes/idc',
                        $this->rootDir.'/include/classes/attachment',
                        $this->rootDir.'/include/classes/contacts'
		];
	}
