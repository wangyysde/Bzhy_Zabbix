...
function create_calendar(time, timeobjects, id, utime_field_id, ishour,parentNodeid) {
	id = id || CLNDR.length;
	if ('undefined' == typeof(utime_field_id)) {
		utime_field_id = null;
	}
	CLNDR[id] = new Object;
	CLNDR[id].clndr = new calendar(id, time, timeobjects, utime_field_id, ishour,parentNodeid);
	return CLNDR[id];
}
...
calendar.prototype = {
	...
	initialize: function(id, stime, timeobjects, utime_field_id, ishour,parentNodeid) {
		this.id = id;
                if(ishour){
                    this.ishour = true;
                }
	...
	syncSDT: function() {
                if(this.ishour){
                    ...
                    this.sdt.setTimeObject(this.year, this.month, this.day,0,0);
                }
	...
	syncCDT: function() {
                if(this.ishour){
                    ...
                    this.cdt.setTimeObject(this.year, this.month, 1,0,0);
                }
	},
