 ...
 */
class bzhyCPageFilter {
    protected static $objectName ='pagefilter';
	...
	private function _getProfiles(array $options) {
		...
		if ($this->config['select_latest']) {
			$this->_profileIds['groupid'] = bzhyCProfile::get(self::GROUP_LATEST_IDX);
			$this->_profileIds['hostid'] = bzhyCProfile::get(self::HOST_LATEST_IDX);
			$this->_profileIds['graphid'] = bzhyCProfile::get(self::GRAPH_LATEST_IDX);
			$this->_profileIds['druleid'] = bzhyCProfile::get(self::DRULE_LATEST_IDX);
		}
		elseif ($this->config['DDReset'] && !$this->config['DDRemember']) {
			...
			$this->_profileIds['groupid'] = bzhyCProfile::get($this->_profileIdx['groups']);
			$this->_profileIds['hostid'] = bzhyCProfile::get($this->_profileIdx['hosts']);
			$this->_profileIds['graphid'] = bzhyCProfile::get($this->_profileIdx['graphs']);
			$this->_profileIds['druleid'] = bzhyCProfile::get($this->_profileIdx['drules']);
		}
		...
		$mapid = (array_key_exists('severitiesMin', $options) && array_key_exists('mapId', $options['severitiesMin']))
			...
			: null;
		$this->_profileIds['severityMin'] = bzhyCProfile::get($this->_profileIdx['severityMin'], null, $mapid);
