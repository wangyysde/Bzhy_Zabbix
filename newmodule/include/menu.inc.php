	...
	$zbx_menu = [
		...
		'admin' => [
			...
			'pages' => [
                ...
                //The following is for new module
                'resource' => [
                    ...
                    'pages' => [
                        [
                            'url' => 'contact_maintence.php',
                            'label' => _('Contacts')
                        ],
                        [
                            'url' => 'file_maintence.php',
                            'label' => _('Files')
                        ],
                        [
                            'url' => 'idcbox_maintence.php',
                            'label' => _('Boxs')
                        ],
                        [
                            'url' => 'idc_information_maintence.php',
                            'label' => _('IDCs')
                        ],
                        [
                            'url' => 'device_list.php',
                ...
                'os' => [
                    'label' => _('OS Management'),
                    'user_type' => USER_TYPE_ZABBIX_USER,
                    'default_page_id' => 0,
                    'pages' => [
                        [
                            'url' => 'auto_install.php',
                            'label' => _('Install OS')
                        ]
                    ]
                ],
