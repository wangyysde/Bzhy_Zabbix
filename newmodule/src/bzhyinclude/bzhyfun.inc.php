...
function bzhy_empty($value) {
    ...
    if (is_string($value) && ($value === '' || strcasecmp($value, 'null') == 0)) {
	return true;
    }
...
*/
function bzhyfindDuplicate(array $arrays, $uniqueField, $uniqueField2 = null) {
    $uniqueValues = [];
